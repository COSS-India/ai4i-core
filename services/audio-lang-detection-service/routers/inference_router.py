...
def get_audio_lang_detection_service(request: Request) -> AudioLangDetectionService:
    """
    Dependency to construct AudioLangDetectionService with configured Triton client.
    ...
    return AudioLangDetectionService(triton_client=triton_client)
...
async def run_inference(
    ...
    try:
        ...
        response = audio_lang_detection_service.run_inference(request_body)
