...
logging_config.service_name = os.getenv("SERVICE_NAME", "llm-service")
...
logger.info("✅ AI4ICore Multi-Tenant Plugin initialized for LLM service")
...
try:
    ...
    app.add_middleware(AuthContextMiddleware, path_prefixes=mm_config.middleware_paths or ["/api/v1/llm"])
