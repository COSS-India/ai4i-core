...
class ModelNotFoundError(ServiceError):
    ...
    def __init__(self, message: str, model_name: str, error_code: str = "MODEL_NOT_FOUND"):
        super().__init__(
            ...
            status_code=404,
            model_name=model_name,
            service_error={"model": model_name, "service": "transliteration"}
        )
...
class ServiceUnavailableError(ServiceError):
    ...
    def __init__(self, message: str, service_name: str = "transliteration", error_code: str = "SERVICE_UNAVAILABLE"):
        super().__init__(
            message=message,
            error_code=error_code,
            status_code=503,
