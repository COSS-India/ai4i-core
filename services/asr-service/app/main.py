...
def create_app() -> FastAPI:
    ...
    if _OBSERVABILITY:
        try:
            ...
            config.enabled = True
            config.apps = config.apps or ["asr"]
    ...
    mt_config.tenant_paths = ["/api/v1/asr"]
    ...
    async def root():
        return {"service": "asr-service", "version": "1.0.0", "status": "running"}
