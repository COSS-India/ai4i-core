...
# NOTE: Model Management Plugin is registered inside lifespan function (line 167-180)
# to ensure Redis client is available and middleware is added before app starts.
# Do NOT register it here - it will cause "Cannot add middleware after application has started" error.
