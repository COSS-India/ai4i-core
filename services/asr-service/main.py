...
if OBSERVABILITY_AVAILABLE:
    try:
        ...
        logger.info("✅ Dhruva Observability Plugin initialized successfully for ASR Service")
    except Exception as e:
        logger.error(f"❌ Failed to initialize Dhruva Observability Plugin: {e}")
        OBSERVABILITY_AVAILABLE = False
else:
    logger.info("ℹ️  Dhruva Observability Plugin not available for ASR Service")
