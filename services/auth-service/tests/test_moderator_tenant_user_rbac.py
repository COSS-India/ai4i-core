...
def _moderator() -> User:
    return User(id=uuid4(), email="test-moderator@example.invalid", username="test-moderator")
...
def _tenant_user() -> User:
    return User(id=uuid4(), email="test-tenant-user@example.invalid", username="test-tenant-user", tenant_id=1)
