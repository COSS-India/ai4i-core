...
class Orchestrator:
    ...
    async def _validate_task_type(self, task_type: str) -> None:
        ...
        allowed_tasks = ["NMT", "ASR", "OCR", "NER", "LLM", "TTS", "PII", "LANGUAGE_DETECTION", "SPEAKER_DIARIZATION", "LANGUAGE_DIARIZATION", "TRANSLITERATION", "AUDIO_LANG_DETECTION", "AUDIO_LANGUAGE_DETECTION", "SMR"]
