...
async def lifespan(app: FastAPI):
    ...
    logger.info("NMT Service started")
    yield
    ...
    logger.info("NMT Service stopped")
...
def create_app() -> FastAPI:
    ...
    if _OBSERVABILITY:
        try:
            ...
            config.enabled = True
            config.apps = config.apps or ["nmt"]
    ...
    mt_config.tenant_paths = ["/api/v1/nmt"]
    ...
    async def root():
        return {"service": "nmt-service", "version": "1.0.2", "status": "running"}
