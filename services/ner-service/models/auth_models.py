"""
Auth models for NER service.

Mirrors the structure used in OCR service so shared auth tables
...
class UserDB(Base):
    ...
    Note: the underlying column name in Postgres is `password_hash`
