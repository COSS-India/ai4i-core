...
def create_app() -> FastAPI:
    ...
    if _OBSERVABILITY:
        try:
            ...
            config.enabled = True
            config.apps = config.apps or ["ner"]
    ...
    try:
        ...
        application.add_middleware(AuthContextMiddleware, path_prefixes=["/api/v1/ner"])
    except Exception as e:
    ...
    mt_config.tenant_paths = ["/api/v1/ner"]
    ...
    async def root():
        return {"service": "ner-service", "version": "1.0.0", "status": "running"}
