...
logging_config.service_name = os.getenv("SERVICE_NAME", "speaker-diarization-service")
...
logger.info("✅ AI4ICore Logging Plugin initialized for Speaker Diarization service")
...
try:
    ...
    app.add_middleware(AuthContextMiddleware, path_prefixes=mm_config.middleware_paths or ["/api/v1/speaker-diarization"])
...
multi_tenant_config.tenant_paths = ["/api/v1/speaker-diarization"]
...
logger.info("✅ AI4ICore Multi-Tenant Plugin initialized for Speaker Diarization service")
