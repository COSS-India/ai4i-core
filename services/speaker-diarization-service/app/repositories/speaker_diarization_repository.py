"""
Speaker Diarization repository utilities.

Provides CRUD operations for speaker diarization requests and results.
"""
...
from app.models.speaker_diarization import SpeakerDiarizationRequestDB, SpeakerDiarizationResultDB
...
class SpeakerDiarizationRepository:
    ...
    async def update_request_status(
    ...
    ) -> Optional[SpeakerDiarizationRequestDB]:
        ...
        try:
            ...
            if not request:
                logger.warning(f"Speaker diarization request {request_id} not found")
                return None
    ...
    async def get_request_by_id(self, request_id: UUID) -> Optional[SpeakerDiarizationRequestDB]:
        """Get speaker diarization request by ID with eager loading of results."""
        try:
