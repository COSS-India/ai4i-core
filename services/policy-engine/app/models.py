...
class PolicyResponse(BaseModel):
    ...
    # Add actual policy values used for service matching (as strings for easier serialization)
    latency_policy: Optional[str] = Field(None, description="Actual latency policy value used")
    cost_policy: Optional[str] = Field(None, description="Actual cost policy value used")
    accuracy_policy: Optional[str] = Field(None, description="Actual accuracy policy value used")