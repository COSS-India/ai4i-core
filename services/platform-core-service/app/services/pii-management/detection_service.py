...
_STOP_WORDS: Dict[str, set] = {
    "en": {
        "is", "are", "am", "was", "were", "my", "our", "the", "a", "an",
        "at", "in", "on", "to", "from", "addr", "address", "lives", "living",
        "stay", "staying",
    },
    "hi": {
        "है", "हूँ", "हो", "था", "थे", "मेरा", "मेरी", "मेरे",
        "का", "की", "के", "में", "पर", "से", "पता", "रहता",
    },
    "mr": {
        "आहे", "होता", "होते", "माझा", "माझी", "माझे",
        "चा", "ची", "चे", "मध्ये", "वर", "ून", "पत्ता", "राहतो",
    },
    "ta": {
        "உள்ளது", "இருக்கிறது", "எனது", "என்",
        "முகவரி", "இல்", "இடத்தில்", "வசிப்பவர்", "எண்",
    },
}
