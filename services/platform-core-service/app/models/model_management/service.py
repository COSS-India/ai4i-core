...
class Service(Base):
    ...
    ref_url = Column(String(200), nullable=True)
    task = Column(JSONB, nullable=True)
    languages = Column(JSONB, nullable=True, default=list)
    license = Column(String(255), nullable=True)
    domain = Column(JSONB, nullable=True, default=list)
    submitter = Column(JSONB, nullable=True)
    training_dataset = Column(JSONB, nullable=True)
    inference_endpoint = Column(JSONB, nullable=True)
