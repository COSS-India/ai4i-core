...
async def update_service_endpoint(
    ...
    try:
        ...
        if result == -1:
            ...
            raise HTTPException(
                status_code=status.HTTP_400_BAD_REQUEST,
                detail="No valid update fields provided. Valid fields: serviceDescription, hardwareDescription, endpoint, inferenceServerType, sslVerify, api_key, healthStatus, benchmarks, isPublished, cost_per_unit, unit_type, tier. Note: name, modelId, modelVersion are not updatable."
            )
