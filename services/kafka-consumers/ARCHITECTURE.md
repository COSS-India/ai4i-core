...
> **Replicas stay at `1` until the write-time guard and the reconciliation
> job that backstops it are live (§11). Once both ship, replicas may be
> raised.** A hard gate, not a preference. Everything below is what makes
> lifting it safe.
