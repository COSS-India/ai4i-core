...
The canonical implementation lives in ``ai4icore_core.platform_core.config``. This module re-exports
its public API so existing ``from ai4icore_<lib>... import ...`` continues
to work. New code should import from ``ai4icore_core.platform_core.config`` directly.
"""
from ai4icore_core.platform_core.config import *  # noqa: F401,F403
...
_real = _import_module("ai4icore_core.platform_core.config")
