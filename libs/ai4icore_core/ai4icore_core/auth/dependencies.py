...
Usage::
    ...
    from ai4icore_core.auth.dependencies import create_require_auth, create_require_role
...
def create_require_auth(jwt_verifier: JWTVerifier):
    ...
    async def _require_auth(
        ...
        from ai4icore_core.exceptions import AuthenticationRequiredError, TokenExpiredError, TokenInvalidError
...
def create_require_role(jwt_verifier: JWTVerifier, *role_names: str):
    ...
    async def _require_role(
        ...
        from ai4icore_core.exceptions import InsufficientPermissionsError
