...
The canonical implementation lives in ``ai4icore_core.service_base.health``. This module re-exports
its public API so existing ``from ai4icore_<lib>... import ...`` continues
to work. New code should import from ``ai4icore_core.service_base.health`` directly.
"""
from ai4icore_core.service_base.health import *  # noqa: F401,F403
...
_real = _import_module("ai4icore_core.service_base.health")
