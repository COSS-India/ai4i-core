...
The canonical implementation lives in ``ai4icore_core.exceptions.exceptions``. This module re-exports
its public API so existing ``from ai4icore_<lib>... import ...`` continues
to work. New code should import from ``ai4icore_core.exceptions.exceptions`` directly.
"""
...
_real = _import_module("ai4icore_core.exceptions.exceptions")
