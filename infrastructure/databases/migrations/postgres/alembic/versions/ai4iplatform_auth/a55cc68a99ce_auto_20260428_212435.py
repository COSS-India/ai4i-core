"""auto_20260428_212435

Revision ID: a55cc68a99ce
Revises: 
Create Date: 2026-04-28 21:24:35.544525
...
def upgrade() -> None:
    ...
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('name', sa.Enum('ADMIN', 'USER', 'GUEST', 'MODERATOR', 'TENANT ADMIN', name='rolename', native_enum=False, length=100), nullable=False),
