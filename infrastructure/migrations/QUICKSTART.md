...
python infrastructure/migrations/cli.py migrate

# Or migrate individually
python infrastructure/migrations/cli.py migrate --database postgres
...
python infrastructure/migrations/cli.py seed --database postgres
...
python infrastructure/migrations/cli.py make:migration create_my_table --database postgres
```

This creates a file at:
```
infrastructure/migrations/migrations/postgres/2024_02_15_HHMMSS_create_my_table.py
```
...
```bash
python infrastructure/migrations/cli.py rollback --database postgres
```
...
python infrastructure/migrations/cli.py migrate:fresh --database postgres

# Create migration
python infrastructure/migrations/cli.py make:migration <name> --database <db>

# Run seeders
python infrastructure/migrations/cli.py seed --database postgres

# Run specific seeder
python infrastructure/migrations/cli.py seed --class MySeeder --database postgres
```
