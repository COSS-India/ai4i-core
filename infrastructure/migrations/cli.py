...
from infrastructure.migrations.core.migration_manager import MigrationManager
from infrastructure.migrations.config import MigrationConfig
...
class MigrationCLI:
    ...
    POSTGRES_DBS = ['auth_db', 'config_db', 'model_management_db', 'multi_tenant_db']
    
    def __init__(self):
        self.migrations_path = project_root / 'infrastructure' / 'migrations' / 'migrations'
